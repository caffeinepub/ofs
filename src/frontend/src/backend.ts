...
import type { AIProcessingResult as _AIProcessingResult, ExternalBlob as _ExternalBlob, FileMetadata as _FileMetadata, Time as _Time, TransferRecord as _TransferRecord, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createQRCodeSession(arg0: string, arg1: bigint): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createQRCodeSession(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async fetchFileMetadataByQRCode(arg0: string): Promise<FileMetadata | null> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchFileMetadataByQRCode(arg0);
    ...
    async getAIProcessingResult(arg0: string): Promise<AIProcessingResult> {
        if (this.processError) {
            try {
                ...
                return from_candid_AIProcessingResult_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getQRCodeSession(arg0: string): Promise<QRCodeSession> {
        if (this.processError) {
            try {
                const result = await this.actor.getQRCodeSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTransferHistory(arg0: Principal): Promise<Array<TransferRecord>> {
        if (this.processError) {
            try {
    ...
    async invalidateQRCodeSession(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.invalidateQRCodeSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordAIProcessing(arg0: string, arg1: Variant_imageCompression_fileRecognition, arg2: string, arg3: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordAIProcessing(arg0, to_candid_variant_n27(this._uploadFile, this._downloadFile, arg1), arg2, await to_candid_opt_n28(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordTransfer(arg0: string, arg1: Principal, arg2: Principal, arg3: FileMetadata, arg4: bigint, arg5: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordTransfer(arg0, arg1, arg2, await to_candid_FileMetadata_n29(this._uploadFile, this._downloadFile, arg3), arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async validateQRCodeSession(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.validateQRCodeSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_AIProcessingResult_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AIProcessingResult): Promise<AIProcessingResult> {
...
async function from_candid_TransferRecord_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransferRecord): Promise<TransferRecord> {
...
async function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FileMetadata]): Promise<FileMetadata | null> {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        resultType: from_candid_variant_n18(_uploadFile, _downloadFile, value.resultType),
        processedFile: record_opt_to_undefined(await from_candid_opt_n19(_uploadFile, _downloadFile, value.processedFile))
    };
}
async function from_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        file: await from_candid_FileMetadata_n13(_uploadFile, _downloadFile, value.file),
        sender: value.sender,
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AIProcessingResult>): Promise<Array<AIProcessingResult>> {
    return await Promise.all(value.map(async (x)=>await from_candid_AIProcessingResult_n15(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TransferRecord>): Promise<Array<TransferRecord>> {
    return await Promise.all(value.map(async (x)=>await from_candid_TransferRecord_n25(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_FileMetadata_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FileMetadata): Promise<_FileMetadata> {
...
function to_candid_variant_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_imageCompression_fileRecognition): {
    imageCompression: null;
} | {
    fileRecognition: null;
} {
