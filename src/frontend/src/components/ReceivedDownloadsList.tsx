...
function FileItem({
  ...
  return (
    <>
      <div
        data-ocid={`history.received.item.${index + 1}`}
      ...
      >
        ...
        <button
          ...
          data-ocid={`history.received.delete_button.${index + 1}`}
...
export default function ReceivedDownloadsList() {
  const { receivedFiles, deleteReceived } = useLocalHistory();
    ...
    return (
      ...
      >
        ...
        <p className="text-base text-muted-foreground mt-1">
          Files received will appear here
        </p>
      </div>
    );
  }
